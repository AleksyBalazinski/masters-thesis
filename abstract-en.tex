\begin{abstract}
    ...
    Through a series of test simulations, including the modeling of spiral galaxies, globular clusters, and galaxy collisions, the methods are benchmarked for accuracy, computational cost, and scalability.
    The findings contribute practical insights into the strengths and limitations of each method.

    \vspace{1.5em}

    \noindent \textbf{Keywords:} gravitational N-body simulations, PM method, P3M method, Barnes-Hut algorithm, performance optimization
\end{abstract}