...
\begin{figure}[htp]
    ...
    \caption{Fundamental physical quantities describing the globular cluster over time in the Barnes-Hut algorithm.
...
The evolution of the system (initial positions and the positions after 200 kyr) is shown in \autoref{fig:cluster-evolution-bh}.
\begin{figure}[htp]
    \centering
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
