...
Despite these shortcomings, tests performed on our machine (utilizing the maximum number of concurrent threads supported, equal to 12) yielded approximately four-fold speedup compared to the single-threaded implementation in a typical simulation.