...
\subsubsection{Assignent function}
...
\end{equation*}
Applying the convolution theorem twice and pulling the constant $(-4\pi G)$ out of the Green's function in \autoref{eq:optimal-greens-func} leaves us with the desired \autoref{eq:reference-force-transform}.
