...
\begin{algorithm}
    ...
    \begin{algorithmic}
        ...
        \ForAll {$j \in \text{HOC}(\mathbf{q}_n)$} \Comment{If sorted linked lists are used, check here for the $|y_i - y_j| > r_e$ condition. If true, flag the $\mathbf{q}_n$ cell as completed and return.}
        \If {$i = j$}
        \Return
        \EndIf
