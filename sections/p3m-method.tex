...
Since only one thread is responsible for updates to particle $i$ coming "from the the right," (or any other "direction") no data races can occur.
This approach has two obvious drawbacks.
First, memory requirements increase significantly as $13N$ additional three-dimensional vectors have to be stored.
